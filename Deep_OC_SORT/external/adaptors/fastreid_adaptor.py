...
import sys
sys.path.append('/Users/horang/Documents/ai/MOT/Deep_OC_SORT/external')
...
class FastReID(torch.nn.Module):
    def __init__(self, weights_path):
        super().__init__()
        config_file = "/Users/horang/Documents/ai/MOT/Deep_OC_SORT/external/fast_reid/configs/ThermalMOT/thermal_mot_sbs_s50.yml"
