...
class EmbeddingComputer:
    ...
    def initialize_model(self):
        ...
        elif self.dataset == "thermal_mot":
            path = "/Users/horang/Documents/ai/MOT/Deep_OC_SORT/external/weights/thermal_mot_sbs_s50.pth"
        else:
    ...
    # def initialize_model(self):
    #     model_path = "/Users/horang/Documents/ai/MOT/weights/checkpoints_exp4.pth"  # 학습한 모델 경로

    #     # 모델을 직접 정의하여 불러오기
    #     model = EmbeddingModel(
    #         model_name="resnet50",  # 저장된 모델과 동일한 구조 사용
    #         embedding_dim=128,
    #         use_pretrained_model=False  # 저장된 모델이 이미 학습된 상태
    #     )
    ...
    #     model.eval()
    #     model.to("mps")  # MPS(GPU) 또는 CUDA 사용 가능
    #     self.model = model
    ...
    def _get_general_model(self):
        ...
        sd = torch.load("/Users/horang/Documents/ai/MOT/Deep_OC_SORT/external/weights/osnet_ain_ms_d_c.pth.tar",map_location='cpu')["state_dict"]
